...
Welcome to my [personal website](https://Brahada.com)!
...
1. Clone the repository:
    ...
    ```bash
    git clone git://github.com/brahadahada/personal-site.git
    cd personal-site
    ```
...
- Special thanks Michael for his websites inspiration [https://mldangelo.com/]